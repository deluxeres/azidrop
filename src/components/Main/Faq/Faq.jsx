          ...
          <div className="faq-wrapper">
            <div className="faq-items">
              ...
              <div className="faq-item">
                  ...
                  <div className="faq-item__text">
                      <span>Средства могут прийти не сразу - подождите 1 час. Если не пришли в течение часа - напишите нам на почту <Link className="faq-item__link" to="/">(azidropmail@mail.ru)</Link>, указав подробные данные платежа.</span>
                  </div>
              </div>
              <div className="faq-item">
                  <div className="faq-item__title">
