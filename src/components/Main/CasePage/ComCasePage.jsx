...
import { useGetCaseQuery } from '../../../app/services/caseApi';
...
function ComCasePage() {
    ...
    const { data: caseElem, isLoading } = useGetCaseQuery({ id });
    ...
    const spinCase = async function () {
        let res = await OpenCase(caseElem.id);
